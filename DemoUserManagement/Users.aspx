        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowEditing="gvUsers_RowEditing" OnRowDeleting="gvUsers_RowDeleting"
                    ...
                    DataKeyNames="UserID" CssClass="table table-striped" OnRowCommand="GridView1_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Resume">
                            <ItemTemplate>
                                <asp:Button ID="btnDownload" runat="server" Text="Download" CommandName="DownloadFile" CommandArgument='<%# Eval("UserID") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
